...
ui <- navbarPage(
  ...
  #     id = "page_3_header",
  #     h1(class = "page-header",
  #        "Text Mining Tweets with Twitter",
  #        tags$small("In Shiny")),
  #     p(class = "lead", "This is the beta version of my first portfolio analytics project in Shiny"),
  #     p(tags$strong("Select the location and number of tweets to analyze"))
  #   ),
  #   verbatimTextOutput(outputId = "sentiment")
  #   
  # ),
...
server <- function(input, output, session){
  ...
  # Sentiment Analysis ----
  # Part 1 - Create the picker input for first stock
  output$stock_1_nlp <- renderUI({
    pickerInput(inputId = "stock_1",
                label = h5("Stock 1"),
                choices = stock_list_tbl$label,
                multiple = FALSE,
